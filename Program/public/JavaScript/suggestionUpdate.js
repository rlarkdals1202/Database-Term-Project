...
const $category = document.getElementById("shelterSuggestionSelect");
const urlSearch = new URLSearchParams(location.search);
const boardId = urlSearch.get('boardId');

async function getBoardInformation()
{
    const boardInfromation = await axios.get(`http://localhost:8080/suggestion/content/?id=${boardId}`, {withCredentials: true});
...
$updateButton.addEventListener("click", () =>
{
    ...
    {
        axios.put("http://localhost:8080/suggestion/update/process",
        {
